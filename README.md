...
NOTE: This is an older version of the code written by Evgeny Smirnov. It has experienced some evolution and can now be found at [smirik/mercury](https://github.com/smirik/mercury).
